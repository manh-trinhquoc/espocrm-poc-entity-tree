...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/PocEntityTree
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/PocEntityTree)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/PocEntityTree`
* `site/tests/integration/Espo/Modules/PocEntityTree`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/PocEntityTree/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/PocEntityTree/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/poc-entity-tree/lib/init.js"
        ]
    }
    ```
